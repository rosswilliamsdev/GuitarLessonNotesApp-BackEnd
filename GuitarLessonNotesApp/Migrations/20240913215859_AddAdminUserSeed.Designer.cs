...
namespace GuitarLessonNotesApp.Migrations
{
    ...
    [Migration("20240913215859_AddAdminUserSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GuitarLessonNotesApp.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admin",
                            PasswordHash = "$2a$12$dBDgbAMoz0myWvpyftZEduvMjYObsO3AZgONkAT4pxyF38cOII8Ai",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("GuitarLessonNotesApp.Models.Student", b =>
                {
                    b.HasOne("GuitarLessonNotesApp.Models.User", "User")
                        .WithMany("Students")
